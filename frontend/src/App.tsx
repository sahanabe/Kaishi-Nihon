...
import SpeedRecognition from './pages/SpeedRecognition';
import Kanji3DHolographic from './pages/Kanji3DHolographic';
import KanjiMemoryPalace from './pages/KanjiMemoryPalace';
import KanjiRhythmMemory from './pages/KanjiRhythmMemory';
import KaishiTest from './pages/KaishiTest';
      ...
      <AuthProvider>
        <Router>
          ...
          <Route path="/language/grammar-fundamentals" element={<GrammarFundamentals />} />
                ...
                <Route path="/language/quick-quiz" element={<QuickQuiz />} />
                <Route path="/language/progress-test" element={<ProgressTest />} />
                <Route path="/language/flashcard-review" element={<FlashcardReview />} />
                <Route path="/language/memory-palace" element={<MemoryPalace />} />
                <Route path="/language/speed-recognition" element={<SpeedRecognition />} />
                <Route path="/language/kaishi-test" element={<KaishiTest />} />
