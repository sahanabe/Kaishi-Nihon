...
const JLPTN5: React.FC = () => {
  ...
  const learningSteps = [
    ...
    },
    {
      ...
      description: 'Comprehensive reading comprehension and listening exercises',
      duration: '4-6 weeks',
      icon: <Volume2 className="w-6 h-6" />,
      color: 'from-purple-500 to-purple-600',
      details: ['Reading comprehension exercises', 'Listening practice with audio', 'Speed reading techniques', 'Audio-visual learning']
    },
    {
      id: 5,
